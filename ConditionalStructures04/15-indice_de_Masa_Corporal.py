...
altura al cuadrado. En función del valor del IMC, el programa debe mostrar por pantalla el diagnósƟco
...
muy altos”.
Si el IMC es menor o igual a 17: “Usted Ɵene infrapeso, aliméntese más”.
Si el IMC es menor o igual a 18: “Usted Ɵene bajo peso, aliméntese mejor”.
Si el IMC es mayor a 18 y menor o igual a 26: “Usted Ɵene un peso saludable, conƟnúe así!”.
...
Si el IMC es mayor a 40: “Usted Ɵene obesidad de grado IV (mórbida), los riesgos para su salud
son muy altos, consulte con su médico a la brevedad”.
'''

#Entrada y/o datos
peso = float(input('Ingrese su peso a continuacion: '))
altura = float(input('Ingrese su altura a continuacion: '))
